  ...
  <div class="collapse navbar-collapse" id="nav_item">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav_item">
       ...
       <li class="nav_item">
        <button value="help" style = "background-color:#33CEFF; font-family: georgia; color: white; position:absolute; top:15px; right:30px;" onclick="HelpAlert(this)">Help</button>
      </li>
    </ul>
