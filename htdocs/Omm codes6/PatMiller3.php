...
<body onload="toggleZoomScreen()">
 ...
 function toggleZoomScreen() {
  ...
  function HelpAlert(e)
        {
          alert("In the current statement, what is the Annual Percentage Rate for balance transfers?");
        }
...
<div style="position:absolute;left:26.00px;top:424.62px" class="cls_013"><span class="cls_013" onclick = "stopTimer(this),setColor(event)"; data-count="1">Opening/Closing Date</span></div>
<div style="position:absolute;left:204.33px;top:425.12px" class="cls_002"><span class="cls_002"><span onclick = "stopTimer(this),setColor(event)"; data-count="1">08/16/2018</span><span onclick = "stopTimer(this),setColor(event)"; data-count="1">-09/15/2018</span></span></div>
...
<div style="position:absolute;left:271.10px;top:641.70px" class="cls_002"><span class="cls_002" onclick = "stopTimer(this),setColor(event)"; data-count="1">$42.38</span></div></div>
...
<div style="position:absolute;left:370.15px;top:604.95px" class="cls_002"><span id = "200" class="cls_002" onclick = "stopTimer(this),setColor(event)"; data-count="1">-</span></div>
...
<BUTTON onclick = "window.location.href='question4.php'" style="position: absolute;right:10px; bottom: 20px;" >Next</BUTTON>
</body>
</html>
