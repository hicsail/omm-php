...
<nav>
  ...
  <span id="sp1">
    ...
    <ul class="navbar-nav">
      ...
      <li>
        <p style = "font-family: georgia;"> Open an account </p>
      </li>
      <li class="nav_item">
    <p class="text-center" style = "font-family: georgia;">OMM VISA</p>
     </li>
      <li>
        <p class="text-right" style = "font-family: georgia; right: 9px">Branch locations</p>
      </li>
