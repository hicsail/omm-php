...
<button value="help" style = "background-color:#33CEFF; font-family: georgia; font-weight: bold; color: black; border: 2px solid black; position:fixed; right:10px;" onclick="stopTimer(this),HelpAlert(this)">Help</button>
