...
<nav>
  ...
  <a href="#" style="font-size: 20px;"><i class="fa fa-fw fa-bars"></i></a>
  <a href="#" style="font-family: georgia; font-size: 20px; left:5px;"> Open an Account</a> 
  <a href="#" style="font-family: georgia; font-size: 40px;"><b> OMM VISA</b></a> 
  <a href="#" style = "font-family: georgia; font-size: 20px;"> Branch Location</a>
...
<form action="login.php" class="container" method="POST">
   <h3 style="color:Black; font-family: georgia;">Welcome</h3>
...
<input type = "submit" value = "Login" name = "submit" id = "bt1">
    <br>
    <a href="forgot.php" style="color: #bb0000; font-family: georgia;" >Forgot username/password</a> 
    <br>
  </form>
<section></section>
<hr>
<br>
<p1 style ="font-family: georgia; font-size: 2em; color: grey" ><center> Rewards Visa Signature Cards</center></p1>

<div id="navbar">
  <a  onclick="newFunction(), startTimer(this)" style = "font-family: georgia;" href="#">Home</a>
  <a href="#" onclick="newFunction(), stopTimer(this)" style = "font-family: georgia;">Rewards</a>
  <a href="#" onclick="newFunction()" style = "font-family: georgia;">Redeem Rewards</a>

<div id="navbar1">
    <a href="#" onclick="newFunction()" style = "font-family: georgia;">Manage Account</a>
      <a href="#" onclick="newFunction()" style = "font-family: georgia;">Contact</a>
</div>
...
<div class="container-fluid">
  <div class="row  text-center">
    <div class="col-12">
       <p class="text" onclick="newFunction()" style = "font-family: georgia;"><strong>Follow Us</strong></p>
    </div>
...
<footer style = "font-family: georgia; background-color: black; color: white">
     <div class="row text-center">
      <div class="col-md-4">
          ...
          <h5 onclick="newFunction()">Mortgage</h5>
 <p onclick="newFunction()">Home equity
      ...
      <div class="col-md-4">
        <h5 onclick="newFunction()">Investment Planning</h5>
 <p>Personalized
        </p>
      ...
      <div class="col-md-4">
        ...
        <h5 onclick="newFunction()">Help & Support</h5>
