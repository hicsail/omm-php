...
<button class="tablink" onclick="openPage('2018', this, 'grey')" id="defaultOpen">2019 Statements</button>
<button class="tablink" onclick="openPage('2017', this, 'grey')" >2018 Statements</button>
